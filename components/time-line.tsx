                ...
                <div className="-my-6">
                    {dataAboutPage.map((data) =>(
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                            ...
                            sm:after:left-0 after:w-2 after:h-2 after:bg-darkBg
                            after:border-4 after:box-content after:boder-slate-50
                            ...
                            after:translate-y-1.5">
                                ...
                                justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-darkBg bg-slate-100 rounded-full">
                                    {data.date}
                                </time>
